...
export interface ChatOptions {
  ...
  chatbotId?: string;
  tools?: any[];
  toolsProvider?: (user: any, options: ChatOptions) => Promise<any[]>;
}
...
export interface AgentContext {
  ...
  sessionId?: string;
  aiProvider?: AIProvider;
  toolExecutor?: (toolName: string, args: any, toolContext: any) => Promise<{success: boolean, message: string}>;
}
...
// AI Provider interfaces for framework independence
