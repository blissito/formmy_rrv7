...
export function BenefitCard({
  ...
  return (
    <div className="relative bg-slate-100 w-full my-2 md:my-4 h-fit lg:h-[124px] py-4 lg:py-0 rounded-3xl items-center justify-between px-4 lg:px-8 gap-4 md:gap-6 grid grid-cols-12">
      <div className="flex flex-col md:flex-row gap-4 col-span-12 md:col-span-4 items-start md:items-center">
        <div
          className={cn(
            "min-h-10 min-w-10 h-10 w-10 md:!min-h-16 md:!min-w-16 text-4xl rounded-xl  flex flex-col items-center justify-center text-black ml-0 md:-ml-16 -mt-8 lg:mt-0"
          )}
        >
