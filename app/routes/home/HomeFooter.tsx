    ...
    <footer className="bg-dark text-white w-full pt-10 md:pt-20 pb-10  border-t border-white/5">
        ...
        <div className="flex flex-col gap-8 min-w-[220px]">
          ...
          <div className="text-lightGray">
            ...
            >
              ...
              <a href="https://www.linkedin.com/company/formmyapp" className="hover:opacity-60"><i className="fa-brands fa-linkedin-in" />
              <FaLinkedinIn />
              </a>
            </div>
          </div>
        ...
        <div className="flex-1 grid grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            ...
            <ul className="space-y-2 text-gray-500 text-sm text-lightGray">
              <Form method="post">
              <button type="submit" name="intent" value="google-login" className="cursor-pointer hover:underline">Pruébalo gratis</button>
              </Form>
              <li><a href="/formularios" className="hover:underline">Formularios</a></li>
              <li><a href="/chat-ia" className="hover:underline">Chat IA</a></li>
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <form className="flex items-center gap-2 mt-2">
              ...
              <button type="submit" className="bg-brand-500 rounded-full min-w-10 h-10 flex items-center justify-center text-white text-lg hover:-rotate-45 transition-all ">→</button>
            </form>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 mt-12 flex flex-col md:flex-row md:justify-between items-center gap-4 border-t border-white/5 pt-8 text-gray-500">
        <div className="flex items-center gap-4">
          <span className="text-xs text-lightGray ">© 2025 Formmy. Derechos reservados.</span>
        </div>
        <div className="flex items-center gap-4 text-xs">
          ...
          <a href="/aviso-de-privacidad" className="text-xs text-lightGray hover:underline">Aviso de Privacidad</a>
          <a href="/terms" className="text-xs text-lightGray hover:underline">Términos y condiciones</a>
        </div>
      </div>
    </footer>
  );
