...
export const ChatIntegrations = () => {
  ...
  function SquareCard({
    ...
    return (
      <div className="flex flex-col col-span-12 md:col-span-4 justify-start items-start bg-slate-100 p-4 md:p-8 rounded-3xl relative">
        <div className="flex gap-4 items-center  mb-4 md:mb-6 ">
        <div
          className={cn(
            "w-12 h-12 md:min-w-16 md:min-h-16 text-4xl rounded-xl flex items-center justify-center text-black  -ml-14 -mt-14",
            // color
          )}
        >
