/**
 * Composio Google Calendar OAuth Callback
 * Maneja el redirect después de que el usuario autoriza Google Calendar
 */
...
export async function loader({ request }: any) {
  try {
    ...
    console.log(`\n${'🔄'.repeat(40)}`);
    console.log(`🔄 [Composio Callback] OAuth callback recibido`);
        ...
        try {
          await db.integration.upsert({
            ...
            create: {
              ...
              // (Composio maneja los tokens internamente, solo necesitamos el connectedAccountId)
        ...
        <html lang="es">
          ...
          <body>
            <div class="container">
              ...
              <p>Google Calendar se ha conectado correctamente a tu cuenta de Formmy.</p>
              <p>Ahora puedes usar Ghosty para gestionar tus eventos de calendario.</p>
    ...
    console.error("❌ Error en callback de Composio:", error);
