...
import { MdOutlineSpeakerNotes, MdOutlineDashboardCustomize } from 'react-icons/md';
...
export function DashboardLayout({ title, children, actionButton, user }: DashboardLayoutProps) {
