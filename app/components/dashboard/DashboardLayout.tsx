  ...
  return (
    <div className={cn("mx-auto w-full overflow-hidden h-full min-h-svh bg-surface flex  flex-col-reverse pr-2 pl-2 box-border overflow-y-scroll", "md:flex-row  md:pr-8 md:pl-0")}>
      <div className={cn("flex flex-row  justify-center  items-center py-0 pb-2 w-full gap-0 rounded-r-3xl  h-auto ",
        ...
        <nav className="relative bg-pink-500 z-10 flex pt-2 flex-row md:flex-col items-center justify-center md:gap-8 gap-0 w-fit md:w-full px-0 md:px-2">
          <IconButtonLink
            to="/dashboard/ghosty"
      ...
      <div className="flex flex-col grow w-full md:pb-8 pb-0 ml-0 md:ml-[120px]">
        <TopMenu user={user} />
        <div className="bg-white relative w-full h-full rounded-3xl md:rounded-[40px] min-h-[calc(100svh-236px)] overflow-y-scroll md:overflow-y-auto max-h-[calc(100vh-156px)] md:max-h-none noscroll">
          {children}
        </div>
      </div>
    </div>
