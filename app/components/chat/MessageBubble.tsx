    ...
    <div className="mt-3 border-t border-dashed border-gray-300 dark:border-gray-600 pt-2">
      ...
      >
        <div className="flex items-center gap-1">
          ...
          <span className="font-medium text-blue-600 dark:text-blue-400">{t('components.messageBubble.debugInfo')}</span>
        </div>
        <svg
...
export const MessageBubble = ({
  ...
  const isWhatsAppMessage = message?.channel?.includes("whatsapp") || isWhatsAppEcho;
